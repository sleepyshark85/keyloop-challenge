...
| **11** | [Risks and technical debt](arc42/11-risks-technical-debt.md) | Generated by `npm run docs:build` from the two shapes debt arrives in: **an ADR with `status: proposed`**, awaiting a human ruling; and **a slice carrying `d… |
