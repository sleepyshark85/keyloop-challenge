...
- [**ADR-0021**](adr/0021-the-booking-seed-is-overridable-by-environment.md) — The booking seed is overridable by environment, unset by default, and announces itself *(proposed)*
