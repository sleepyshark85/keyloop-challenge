...
- **Authentication, authorisation, sessions, rate limiting and per-actor audit**
  ([ADR-0034](../adr/0034-the-caller-is-a-user-and-the-system-does-not-name-the-role.md), GC-2). **†** The service is therefore unsafe to expose on any reachable network,
